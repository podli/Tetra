<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AllView.aspx.cs" Inherits="_AllView" %>
            ...
            <div class="options">
                ...
                <div style="width:200px; float: left;">
                   ...
                   <AlternatingRowStyle BackColor="#dde4ec"  />
                    ...
                    <asp:GridView ID="gvDrawOnMap" runat="server" CssClass="gvDrawOnMap">
                    </asp:GridView>
                </div>

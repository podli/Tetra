<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Positions.aspx.cs" Inherits="_Positions" %>
            ...
            <asp:Label ID="Label2" runat="server" CssClass="lbl"></asp:Label> 
                ...
                <div style="width:200px; float: left;">
                   ...
                   <AlternatingRowStyle BackColor="#dde4ec"  />
                    ...
                    <asp:GridView ID="gvDrawOnMap" runat="server">
                    </asp:GridView>
                </div>
